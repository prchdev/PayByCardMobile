...
import { View, Text, TouchableOpacity, ScrollView, TextInput, ActivityIndicator, Modal, Pressable, Alert, KeyboardAvoidingView, Platform, SafeAreaView } from 'react-native';
