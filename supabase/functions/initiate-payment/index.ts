...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const transactionSummary = {
      ...
      surcharge_percentage: chargesData.surchargePercentage || 0,
      base_charges_percentage: chargesData.baseChargesPercentage || 0,
      effective_charges_percentage: chargesData.effectiveChargesPercentage || 0,
      card_type: cardType,
